...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-10 col-sm-12">
      <div class="card">
        <div class="card-header"><b>SCHEDA DI ISCRIZIONE AI CORSI</b></div>
        <div class="card-body">
          @if ($errors->any())
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="col-xs-10 col-sm-10 col-md-10">
                        <label>Sono d'accordo a condividere con gli altri corsisti telefono ed email per organizzare i trasporti ? (si/no)</label>
                      </div>
                   ...
                   <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                      <input name="subscribe" class="btn btn-lg btn-success" type="submit" value="Completa Iscrizione"/>
                    </div>
                  </div>
                </form>
              </div>
