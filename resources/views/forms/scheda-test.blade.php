      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6">
          <div class="form-group">
            <label>Nome:</label>
            <input type="text" name="name" id="name" class="form-control input-lg" placeholder="" value="gabri">
          </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
          <div class="form-group">
            <label>Cognome:</label>
            <input type="text" name="surname" id="surname" class="form-control input-lg" placeholder="" value="soldati">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="job" value="lavoro">
          </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
          <div class="form-group">
            <label>Arrivo da:</label>
            <input type="text" name="city" id="city" class="form-control input-lg" placeholder="" value="citta">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
              <label>Email:</label>
              <input type="text" class="form-control" name="email" value="email@test.com">
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
              <label>Ripeti email:</label>
              <input type="text" class="form-control" name="email_again" id="email_again" value="email@test.com">
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control decimals" name="phone" value="3355555555">
            </div>
          </div>
